...
class _TransactionCardState extends State<TransactionCard> {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      shrinkWrap: true, // список занимает только нужное место
      physics: const NeverScrollableScrollPhysics(), // убираем скролл внутри
              ...
              Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Icon(Icons.circle,
                          color: Color(transaction.categoryColor), size: 12),
