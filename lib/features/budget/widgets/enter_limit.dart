...
class EnterLimit extends StatefulWidget {
  final ValueChanged<String> selectedAmount;
  const EnterLimit({super.key, required this.selectedAmount});

  @override
  State<EnterLimit> createState() => _EnterLimitState();
}

class _EnterLimitState extends State<EnterLimit> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('Enter monthly Limit', style: AppTextStyles.widgetLabel),
          TextField(
